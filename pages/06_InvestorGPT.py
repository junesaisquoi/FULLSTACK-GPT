...
class CompanyOverviewArgsSchema(BaseModel):
    symbol: str = Field(description="Stock ticker symbol of the company. Example: AAPL, TSLA")

class CompanyOverviewTool(BaseTool):
    name: str = "CompanyOverview"
    description: str = """
    Use this to get an orverview of the financials of the company.
    You should entera stock ticker symbol.
    """
